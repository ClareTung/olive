package com.olive.es.start.service.base;
...
import com.olive.es.start.model.entity.UserInfo;
...
public class DocumentService2 {
    ...
    public Object existsDocument() {
        ...
        try {
            // 获取请求对象
            GetRequest getRequest = new GetRequest("es-start-user", "doc", "1");
            // 是否获取源码内容
    ...
    public Object addDocument() {
        ...
        try {
            // 创建索引请求对象
            IndexRequest indexRequest = new IndexRequest("es-start-user", "doc", "1");
            // 创建用户信息
    ...
    public Object updateDocument() {
        ...
        try {
            // 创建索引请求对象
            UpdateRequest updateRequest = new UpdateRequest("es-start-user", "doc", "1");
            // 设置用户更新信息
            UserInfo userInfo = new UserInfo();
    ...
    public Object deleteDocument() {
        ...
        try {
            // 创建删除请求对象
            DeleteRequest deleteRequest = new DeleteRequest("es-start-user", "doc", "1");
            // 执行删除文档
